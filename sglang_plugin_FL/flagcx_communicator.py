...
Usage:
  SGLANG_OOT_COMMUNICATOR=1 SGLANG_OOT_DIST_BACKEND=flagcx \
      FLAGCX_PATH=/path/to/FlagCX \
      SGLANG_OOT_PLUGINS=sglang_plugin_FL python -m sglang.launch_server --tp 2 ...
"""
...
class FlagCXCommunicator:
    ...
    def __init__(self, group, device):
        ...
        try:
            ...
            logger.warning(f"FlagCX wrapper import failed: {e}. Falling back to torch.distributed.")
            self.disabled = True
            return
